        ...
        <template v-for="({type, data, cancel}) in list">
          <template v-if="type === 'role'">
            <li v-for="item in data" :key="item.roleId">
                <img src="@/assets/workflow/icon_role.png">
                <span>{{item.roleName}}</span>
                <img src="@/assets/workflow/cancel.png" @click="cancel(item)">
            </li>
          </template>
          <template v-if="type === 'department'">
            <li v-for="item in data" :key="item.id">
                <img src="@/assets/workflow/icon_file.png">
          ...
          <template v-if="type === 'employee'">
            <li v-for="item in data" :key="item.id">
                <img src="@/assets/workflow/icon_people.png">
